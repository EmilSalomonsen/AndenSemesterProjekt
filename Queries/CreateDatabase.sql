...
CREATE TABLE [AssignAttendant] (
    ...
    CONSTRAINT [FK_AssignAttendant_Routes_RouteID] FOREIGN KEY ([RouteID]) REFERENCES [Routes] ([RouteID]) ON DELETE CASCADE,
    CONSTRAINT [FK_AssignAttendant_Attendant_AttendantID] FOREIGN KEY ([AttendantID]) REFERENCES [Attendant] ([AttendantID]) ON DELETE NO ACTION 
    --SKAL MULIGVIS FIKSES GRUNDET NO ACTION I ATTENDANTID
